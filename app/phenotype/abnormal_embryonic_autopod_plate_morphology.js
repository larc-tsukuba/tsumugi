...
const url_elements = "../../data/phenotype/abnormal_embryonic_autopod_plate_morphology.json.gz";
...
target_phenotype = "abnormal_embryonic_autopod_plate_morphology".replace(/_/g, " ");
