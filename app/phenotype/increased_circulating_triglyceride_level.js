...
const url_elements = "../../data/phenotype/increased_circulating_triglyceride_level.json.gz";
...
target_phenotype = "increased_circulating_triglyceride_level".replace(/_/g, " ");
