...
const url_elements = "../../data/phenotype/decreased_circulating_serum_albumin_level.json.gz";
...
target_phenotype = "decreased_circulating_serum_albumin_level".replace(/_/g, " ");
