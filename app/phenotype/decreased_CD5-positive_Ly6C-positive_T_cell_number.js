...
const url_elements = "../../data/phenotype/decreased_CD5-positive_Ly6C-positive_T_cell_number.json.gz";
...
target_phenotype = "decreased_CD5-positive_Ly6C-positive_T_cell_number".replace(/_/g, " ");
