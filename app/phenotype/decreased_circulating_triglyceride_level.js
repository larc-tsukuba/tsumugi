...
const url_elements = "../../data/phenotype/decreased_circulating_triglyceride_level.json.gz";
...
target_phenotype = "decreased_circulating_triglyceride_level".replace(/_/g, " ");
