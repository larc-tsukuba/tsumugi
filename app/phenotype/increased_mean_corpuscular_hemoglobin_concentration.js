...
const url_elements = "../../data/phenotype/increased_mean_corpuscular_hemoglobin_concentration.json.gz";
...
target_phenotype = "increased_mean_corpuscular_hemoglobin_concentration".replace(/_/g, " ");
