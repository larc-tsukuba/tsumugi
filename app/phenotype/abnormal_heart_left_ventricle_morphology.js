...
const url_elements = "../../data/phenotype/abnormal_heart_left_ventricle_morphology.json.gz";
...
target_phenotype = "abnormal_heart_left_ventricle_morphology".replace(/_/g, " ");
