...
const url_elements = "../../data/phenotype/decreased_Ly6C-positive_NK_T_cell_number.json.gz";
...
target_phenotype = "decreased_Ly6C-positive_NK_T_cell_number".replace(/_/g, " ");
