...
const url_elements = "../../data/phenotype/abnormal_contextual_conditioning_behavior.json.gz";
...
target_phenotype = "abnormal_contextual_conditioning_behavior".replace(/_/g, " ");
