...
const url_elements = "../../data/phenotype/increased_CD8-positive,_naive_alpha-beta_T_cell_number.json.gz";
...
target_phenotype = "increased_CD8-positive,_naive_alpha-beta_T_cell_number".replace(/_/g, " ");
