...
const url_elements = "../../data/phenotype/decreased_circulating_LDL_cholesterol_level.json.gz";
...
target_phenotype = "decreased_circulating_LDL_cholesterol_level".replace(/_/g, " ");
