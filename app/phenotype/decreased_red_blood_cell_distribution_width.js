...
const url_elements = "../../data/phenotype/decreased_red_blood_cell_distribution_width.json.gz";
...
target_phenotype = "decreased_red_blood_cell_distribution_width".replace(/_/g, " ");
