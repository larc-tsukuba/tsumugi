...
const url_elements = "../../data/phenotype/decreased_effector_memory_CD8-positive,_alpha-beta_T_cell_number.json.gz";
...
target_phenotype = "decreased_effector_memory_CD8-positive,_alpha-beta_T_cell_number".replace(/_/g, " ");
