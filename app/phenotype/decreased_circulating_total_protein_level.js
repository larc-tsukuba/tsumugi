...
const url_elements = "../../data/phenotype/decreased_circulating_total_protein_level.json.gz";
...
target_phenotype = "decreased_circulating_total_protein_level".replace(/_/g, " ");
