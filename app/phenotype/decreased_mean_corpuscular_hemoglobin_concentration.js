...
const url_elements = "../../data/phenotype/decreased_mean_corpuscular_hemoglobin_concentration.json.gz";
...
target_phenotype = "decreased_mean_corpuscular_hemoglobin_concentration".replace(/_/g, " ");
