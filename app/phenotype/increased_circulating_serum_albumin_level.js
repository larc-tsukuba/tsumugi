...
const url_elements = "../../data/phenotype/increased_circulating_serum_albumin_level.json.gz";
...
target_phenotype = "increased_circulating_serum_albumin_level".replace(/_/g, " ");
