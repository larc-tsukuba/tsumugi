...
const url_elements = "../../data/phenotype/decreased_circulating_HDL_cholesterol_level.json.gz";
...
target_phenotype = "decreased_circulating_HDL_cholesterol_level".replace(/_/g, " ");
