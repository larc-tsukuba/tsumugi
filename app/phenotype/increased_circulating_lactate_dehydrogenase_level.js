...
const url_elements = "../../data/phenotype/increased_circulating_lactate_dehydrogenase_level.json.gz";
...
target_phenotype = "increased_circulating_lactate_dehydrogenase_level".replace(/_/g, " ");
