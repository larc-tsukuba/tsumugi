...
const url_elements = "../../data/phenotype/abnormal_retina_inner_nuclear_layer_morphology.json.gz";
...
target_phenotype = "abnormal_retina_inner_nuclear_layer_morphology".replace(/_/g, " ");
