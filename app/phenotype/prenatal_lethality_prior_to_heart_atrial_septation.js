...
const url_elements = "../../data/phenotype/prenatal_lethality_prior_to_heart_atrial_septation.json.gz";
...
target_phenotype = "prenatal_lethality_prior_to_heart_atrial_septation".replace(/_/g, " ");
