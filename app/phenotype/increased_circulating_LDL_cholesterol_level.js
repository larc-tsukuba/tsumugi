...
const url_elements = "../../data/phenotype/increased_circulating_LDL_cholesterol_level.json.gz";
...
target_phenotype = "increased_circulating_LDL_cholesterol_level".replace(/_/g, " ");
