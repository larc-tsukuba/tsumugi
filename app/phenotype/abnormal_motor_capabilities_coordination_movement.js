...
const url_elements = "../../data/phenotype/abnormal_motor_capabilities_coordination_movement.json.gz";
...
target_phenotype = "abnormal_motor_capabilities_coordination_movement".replace(/_/g, " ");
