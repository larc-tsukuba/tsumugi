...
const url_elements = "../../data/phenotype/decreased_circulating_free_fatty_acids_level.json.gz";
...
target_phenotype = "decreased_circulating_free_fatty_acids_level".replace(/_/g, " ");
