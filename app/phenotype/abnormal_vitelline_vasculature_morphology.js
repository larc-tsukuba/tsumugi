...
const url_elements = "../../data/phenotype/abnormal_vitelline_vasculature_morphology.json.gz";
...
target_phenotype = "abnormal_vitelline_vasculature_morphology".replace(/_/g, " ");
