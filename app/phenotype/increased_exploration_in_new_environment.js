...
const url_elements = "../../data/phenotype/increased_exploration_in_new_environment.json.gz";
...
target_phenotype = "increased_exploration_in_new_environment".replace(/_/g, " ");
