...
const url_elements = "../../data/phenotype/decreased_circulating_alanine_transaminase_level.json.gz";
...
target_phenotype = "decreased_circulating_alanine_transaminase_level".replace(/_/g, " ");
