...
const url_elements = "../../data/phenotype/embryonic_lethality_prior_to_organogenesis.json.gz";
...
target_phenotype = "embryonic_lethality_prior_to_organogenesis".replace(/_/g, " ");
