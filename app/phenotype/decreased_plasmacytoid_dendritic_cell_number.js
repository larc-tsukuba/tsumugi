...
const url_elements = "../../data/phenotype/decreased_plasmacytoid_dendritic_cell_number.json.gz";
...
target_phenotype = "decreased_plasmacytoid_dendritic_cell_number".replace(/_/g, " ");
