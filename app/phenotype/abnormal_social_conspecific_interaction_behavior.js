...
const url_elements = "../../data/phenotype/abnormal_social_conspecific_interaction_behavior.json.gz";
...
target_phenotype = "abnormal_social_conspecific_interaction_behavior".replace(/_/g, " ");
