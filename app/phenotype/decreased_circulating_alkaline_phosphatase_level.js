...
const url_elements = "../../data/phenotype/decreased_circulating_alkaline_phosphatase_level.json.gz";
...
target_phenotype = "decreased_circulating_alkaline_phosphatase_level".replace(/_/g, " ");
