...
const url_elements = "../../data/phenotype/abnormal_fasting_circulating_glucose_level.json.gz";
...
target_phenotype = "abnormal_fasting_circulating_glucose_level".replace(/_/g, " ");
