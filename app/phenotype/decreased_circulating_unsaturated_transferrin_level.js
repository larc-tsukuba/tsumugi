...
const url_elements = "../../data/phenotype/decreased_circulating_unsaturated_transferrin_level.json.gz";
...
target_phenotype = "decreased_circulating_unsaturated_transferrin_level".replace(/_/g, " ");
