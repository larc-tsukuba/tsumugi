...
const url_elements = "../../data/phenotype/abnormal_circulating_LDL_cholesterol_level.json.gz";
...
target_phenotype = "abnormal_circulating_LDL_cholesterol_level".replace(/_/g, " ");
