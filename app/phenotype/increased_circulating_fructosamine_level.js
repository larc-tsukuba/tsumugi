...
const url_elements = "../../data/phenotype/increased_circulating_fructosamine_level.json.gz";
...
target_phenotype = "increased_circulating_fructosamine_level".replace(/_/g, " ");
