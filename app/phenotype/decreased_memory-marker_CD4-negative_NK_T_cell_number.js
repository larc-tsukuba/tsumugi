...
const url_elements = "../../data/phenotype/decreased_memory-marker_CD4-negative_NK_T_cell_number.json.gz";
...
target_phenotype = "decreased_memory-marker_CD4-negative_NK_T_cell_number".replace(/_/g, " ");
