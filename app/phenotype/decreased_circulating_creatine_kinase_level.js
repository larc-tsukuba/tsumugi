...
const url_elements = "../../data/phenotype/decreased_circulating_creatine_kinase_level.json.gz";
...
target_phenotype = "decreased_circulating_creatine_kinase_level".replace(/_/g, " ");
