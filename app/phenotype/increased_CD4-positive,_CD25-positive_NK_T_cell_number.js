...
const url_elements = "../../data/phenotype/increased_CD4-positive,_CD25-positive_NK_T_cell_number.json.gz";
...
target_phenotype = "increased_CD4-positive,_CD25-positive_NK_T_cell_number".replace(/_/g, " ");
