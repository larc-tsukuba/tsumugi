...
const url_elements = "../../data/phenotype/increased_mechanical_nociceptive_threshold.json.gz";
...
target_phenotype = "increased_mechanical_nociceptive_threshold".replace(/_/g, " ");
