...
const url_elements = "../../data/phenotype/enhanced_contextual_conditioning_behavior.json.gz";
...
target_phenotype = "enhanced_contextual_conditioning_behavior".replace(/_/g, " ");
