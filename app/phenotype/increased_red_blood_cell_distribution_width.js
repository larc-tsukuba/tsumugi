...
const url_elements = "../../data/phenotype/increased_red_blood_cell_distribution_width.json.gz";
...
target_phenotype = "increased_red_blood_cell_distribution_width".replace(/_/g, " ");
