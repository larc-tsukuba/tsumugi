...
const url_elements = "../../data/phenotype/impaired_contextual_conditioning_behavior.json.gz";
...
target_phenotype = "impaired_contextual_conditioning_behavior".replace(/_/g, " ");
