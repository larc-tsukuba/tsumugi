...
const url_elements = "../../data/phenotype/decreased_circulating_lactate_dehydrogenase_level.json.gz";
...
target_phenotype = "decreased_circulating_lactate_dehydrogenase_level".replace(/_/g, " ");
