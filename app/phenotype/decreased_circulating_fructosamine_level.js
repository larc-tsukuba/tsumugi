...
const url_elements = "../../data/phenotype/decreased_circulating_fructosamine_level.json.gz";
...
target_phenotype = "decreased_circulating_fructosamine_level".replace(/_/g, " ");
