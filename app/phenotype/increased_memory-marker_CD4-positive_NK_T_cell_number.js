...
const url_elements = "../../data/phenotype/increased_memory-marker_CD4-positive_NK_T_cell_number.json.gz";
...
target_phenotype = "increased_memory-marker_CD4-positive_NK_T_cell_number".replace(/_/g, " ");
