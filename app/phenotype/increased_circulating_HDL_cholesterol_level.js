...
const url_elements = "../../data/phenotype/increased_circulating_HDL_cholesterol_level.json.gz";
...
target_phenotype = "increased_circulating_HDL_cholesterol_level".replace(/_/g, " ");
