...
const url_elements = "../../data/phenotype/abnormal_circulating_alkaline_phosphatase_level.json.gz";
...
target_phenotype = "abnormal_circulating_alkaline_phosphatase_level".replace(/_/g, " ");
