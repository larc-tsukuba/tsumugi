...
const url_elements = "../../data/phenotype/increased_Ly6C-positive_NK_T_cell_number.json.gz";
...
target_phenotype = "increased_Ly6C-positive_NK_T_cell_number".replace(/_/g, " ");
