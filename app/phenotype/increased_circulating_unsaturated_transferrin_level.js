...
const url_elements = "../../data/phenotype/increased_circulating_unsaturated_transferrin_level.json.gz";
...
target_phenotype = "increased_circulating_unsaturated_transferrin_level".replace(/_/g, " ");
