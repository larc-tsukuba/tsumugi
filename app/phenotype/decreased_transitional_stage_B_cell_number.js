...
const url_elements = "../../data/phenotype/decreased_transitional_stage_B_cell_number.json.gz";
...
target_phenotype = "decreased_transitional_stage_B_cell_number".replace(/_/g, " ");
