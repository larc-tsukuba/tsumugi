...
const url_elements = "../../data/phenotype/increased_circulating_aspartate_transaminase_level.json.gz";
...
target_phenotype = "increased_circulating_aspartate_transaminase_level".replace(/_/g, " ");
