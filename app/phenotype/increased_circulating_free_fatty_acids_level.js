...
const url_elements = "../../data/phenotype/increased_circulating_free_fatty_acids_level.json.gz";
...
target_phenotype = "increased_circulating_free_fatty_acids_level".replace(/_/g, " ");
