...
const url_elements = "../../data/phenotype/increased_circulating_total_protein_level.json.gz";
...
target_phenotype = "increased_circulating_total_protein_level".replace(/_/g, " ");
