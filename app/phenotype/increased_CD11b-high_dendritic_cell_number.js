...
const url_elements = "../../data/phenotype/increased_CD11b-high_dendritic_cell_number.json.gz";
...
target_phenotype = "increased_CD11b-high_dendritic_cell_number".replace(/_/g, " ");
