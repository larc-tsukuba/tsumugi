...
const url_elements = "../../data/phenotype/abnormal_sensory_capabilities_reflexes_nociception.json.gz";
...
target_phenotype = "abnormal_sensory_capabilities_reflexes_nociception".replace(/_/g, " ");
