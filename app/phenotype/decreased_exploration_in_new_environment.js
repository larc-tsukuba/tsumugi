...
const url_elements = "../../data/phenotype/decreased_exploration_in_new_environment.json.gz";
...
target_phenotype = "decreased_exploration_in_new_environment".replace(/_/g, " ");
