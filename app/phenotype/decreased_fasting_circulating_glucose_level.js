...
const url_elements = "../../data/phenotype/decreased_fasting_circulating_glucose_level.json.gz";
...
target_phenotype = "decreased_fasting_circulating_glucose_level".replace(/_/g, " ");
