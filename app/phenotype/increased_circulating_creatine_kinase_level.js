...
const url_elements = "../../data/phenotype/increased_circulating_creatine_kinase_level.json.gz";
...
target_phenotype = "increased_circulating_creatine_kinase_level".replace(/_/g, " ");
