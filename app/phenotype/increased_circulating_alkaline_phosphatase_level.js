...
const url_elements = "../../data/phenotype/increased_circulating_alkaline_phosphatase_level.json.gz";
...
target_phenotype = "increased_circulating_alkaline_phosphatase_level".replace(/_/g, " ");
