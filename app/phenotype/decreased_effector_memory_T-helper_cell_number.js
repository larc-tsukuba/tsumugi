...
const url_elements = "../../data/phenotype/decreased_effector_memory_T-helper_cell_number.json.gz";
...
target_phenotype = "decreased_effector_memory_T-helper_cell_number".replace(/_/g, " ");
