...
const target_phenotype = 'eyelids_fail_to_open'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/eyelids_fail_to_open.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_eyelids_fail_to_open.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_eyelids_fail_to_open.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
