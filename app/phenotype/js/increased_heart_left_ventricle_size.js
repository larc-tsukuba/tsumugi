...
const target_phenotype = 'increased_heart_left_ventricle_size'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/increased_heart_left_ventricle_size.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_increased_heart_left_ventricle_size.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_increased_heart_left_ventricle_size.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
