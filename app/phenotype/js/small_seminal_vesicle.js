...
const target_phenotype = 'small_seminal_vesicle'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/small_seminal_vesicle.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_small_seminal_vesicle.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_small_seminal_vesicle.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
