...
const target_phenotype = 'increased_blood_uric_acid_level'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/increased_blood_uric_acid_level.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_increased_blood_uric_acid_level.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_increased_blood_uric_acid_level.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
