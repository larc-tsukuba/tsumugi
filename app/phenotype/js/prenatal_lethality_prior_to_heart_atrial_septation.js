...
const target_phenotype = 'prenatal_lethality_prior_to_heart_atrial_septation'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/prenatal_lethality_prior_to_heart_atrial_septation.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_prenatal_lethality_prior_to_heart_atrial_septation.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_prenatal_lethality_prior_to_heart_atrial_septation.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
