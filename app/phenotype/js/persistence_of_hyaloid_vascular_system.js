...
const target_phenotype = 'persistence_of_hyaloid_vascular_system'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/persistence_of_hyaloid_vascular_system.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_persistence_of_hyaloid_vascular_system.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_persistence_of_hyaloid_vascular_system.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
