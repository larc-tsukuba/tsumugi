...
const target_phenotype = 'prolonged_QRS_complex_duration'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/prolonged_QRS_complex_duration.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_prolonged_QRS_complex_duration.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_prolonged_QRS_complex_duration.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
