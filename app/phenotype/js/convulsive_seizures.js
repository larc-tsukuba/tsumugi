...
const target_phenotype = 'convulsive_seizures'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/convulsive_seizures.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_convulsive_seizures.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_convulsive_seizures.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
