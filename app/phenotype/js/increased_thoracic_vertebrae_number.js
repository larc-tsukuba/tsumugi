...
const target_phenotype = 'increased_thoracic_vertebrae_number'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/increased_thoracic_vertebrae_number.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_increased_thoracic_vertebrae_number.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_increased_thoracic_vertebrae_number.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
