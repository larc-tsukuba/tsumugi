...
const target_phenotype = 'abnormal_contextual_conditioning_behavior'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_contextual_conditioning_behavior.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_contextual_conditioning_behavior.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_contextual_conditioning_behavior.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
