...
const target_phenotype = 'embryonic_lethality_prior_to_organogenesis'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/embryonic_lethality_prior_to_organogenesis.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_embryonic_lethality_prior_to_organogenesis.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_embryonic_lethality_prior_to_organogenesis.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
