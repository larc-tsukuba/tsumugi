...
const target_phenotype = 'irregularly_shaped_pupil'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/irregularly_shaped_pupil.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_irregularly_shaped_pupil.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_irregularly_shaped_pupil.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
