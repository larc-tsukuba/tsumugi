...
const target_phenotype = 'urinary_bladder_obstruction'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/urinary_bladder_obstruction.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_urinary_bladder_obstruction.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_urinary_bladder_obstruction.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
