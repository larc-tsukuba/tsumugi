...
const target_phenotype = 'increased_lung_tissue_damping'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/increased_lung_tissue_damping.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_increased_lung_tissue_damping.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_increased_lung_tissue_damping.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
