...
const target_phenotype = 'aorta_stenosis'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/aorta_stenosis.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_aorta_stenosis.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_aorta_stenosis.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
