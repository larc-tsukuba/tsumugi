...
const target_phenotype = 'prolonged_PR_interval'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/prolonged_PR_interval.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_prolonged_PR_interval.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_prolonged_PR_interval.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
