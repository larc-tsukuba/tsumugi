...
const target_phenotype = 'narrow_eye_opening'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/narrow_eye_opening.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_narrow_eye_opening.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_narrow_eye_opening.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
