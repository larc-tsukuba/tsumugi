...
const target_phenotype = 'thin_ventricular_wall'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/thin_ventricular_wall.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_thin_ventricular_wall.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_thin_ventricular_wall.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
