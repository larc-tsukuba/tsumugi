...
const target_phenotype = 'decreased_cardiac_output'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/decreased_cardiac_output.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_decreased_cardiac_output.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_decreased_cardiac_output.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
