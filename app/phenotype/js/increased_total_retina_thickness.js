...
const target_phenotype = 'increased_total_retina_thickness'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/increased_total_retina_thickness.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_increased_total_retina_thickness.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_increased_total_retina_thickness.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
