...
const target_phenotype = 'abnormal_sensory_capabilities_reflexes_nociception'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_sensory_capabilities_reflexes_nociception.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_sensory_capabilities_reflexes_nociception.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_sensory_capabilities_reflexes_nociception.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
