...
const target_phenotype = 'small_superior_vagus_ganglion'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/small_superior_vagus_ganglion.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_small_superior_vagus_ganglion.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_small_superior_vagus_ganglion.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
