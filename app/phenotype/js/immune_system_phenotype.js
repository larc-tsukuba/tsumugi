...
const target_phenotype = 'immune_system_phenotype'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/immune_system_phenotype.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_immune_system_phenotype.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_immune_system_phenotype.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
