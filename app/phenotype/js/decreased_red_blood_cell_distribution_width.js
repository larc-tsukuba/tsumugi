...
const target_phenotype = 'decreased_red_blood_cell_distribution_width'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/decreased_red_blood_cell_distribution_width.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_decreased_red_blood_cell_distribution_width.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_decreased_red_blood_cell_distribution_width.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
