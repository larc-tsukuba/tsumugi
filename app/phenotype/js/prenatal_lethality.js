...
const target_phenotype = 'prenatal_lethality'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/prenatal_lethality.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_prenatal_lethality.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_prenatal_lethality.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
