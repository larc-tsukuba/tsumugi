...
const target_phenotype = 'absent_external_male_genitalia'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/absent_external_male_genitalia.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_absent_external_male_genitalia.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_absent_external_male_genitalia.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
