...
const target_phenotype = 'cornea_vascularization'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/cornea_vascularization.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_cornea_vascularization.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_cornea_vascularization.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
