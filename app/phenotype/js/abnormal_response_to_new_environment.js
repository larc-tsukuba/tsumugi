...
const target_phenotype = 'abnormal_response_to_new_environment'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_response_to_new_environment.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_response_to_new_environment.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_response_to_new_environment.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
