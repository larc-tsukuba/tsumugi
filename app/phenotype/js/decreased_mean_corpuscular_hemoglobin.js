...
const target_phenotype = 'decreased_mean_corpuscular_hemoglobin'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/decreased_mean_corpuscular_hemoglobin.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_decreased_mean_corpuscular_hemoglobin.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_decreased_mean_corpuscular_hemoglobin.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
