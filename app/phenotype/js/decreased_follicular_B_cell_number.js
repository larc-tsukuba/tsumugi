...
const target_phenotype = 'decreased_follicular_B_cell_number'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/decreased_follicular_B_cell_number.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_decreased_follicular_B_cell_number.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_decreased_follicular_B_cell_number.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
