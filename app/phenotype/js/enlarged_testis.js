...
const target_phenotype = 'enlarged_testis'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/enlarged_testis.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_enlarged_testis.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_enlarged_testis.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
