...
const target_phenotype = 'abnormal_eye_anterior_chamber_depth'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_eye_anterior_chamber_depth.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_eye_anterior_chamber_depth.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_eye_anterior_chamber_depth.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
