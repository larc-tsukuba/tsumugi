...
const target_phenotype = 'abnormal_bone_marrow_morphology'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_bone_marrow_morphology.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_bone_marrow_morphology.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_bone_marrow_morphology.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
