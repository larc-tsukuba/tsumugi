...
const target_phenotype = 'impaired_glucose_tolerance'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/impaired_glucose_tolerance.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_impaired_glucose_tolerance.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_impaired_glucose_tolerance.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
