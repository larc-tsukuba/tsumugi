...
const target_phenotype = 'fused_phalanges'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/fused_phalanges.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_fused_phalanges.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_fused_phalanges.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
