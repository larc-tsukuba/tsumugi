...
const target_phenotype = 'cornea_opacity'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/cornea_opacity.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_cornea_opacity.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_cornea_opacity.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
