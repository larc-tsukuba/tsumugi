...
const target_phenotype = 'abnormal_spatial_working_memory'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_spatial_working_memory.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_spatial_working_memory.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_spatial_working_memory.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
