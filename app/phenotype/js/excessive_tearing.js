...
const target_phenotype = 'excessive_tearing'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/excessive_tearing.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_excessive_tearing.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_excessive_tearing.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
