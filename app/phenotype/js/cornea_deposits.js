...
const target_phenotype = 'cornea_deposits'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/cornea_deposits.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_cornea_deposits.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_cornea_deposits.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
