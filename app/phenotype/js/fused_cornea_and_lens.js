...
const target_phenotype = 'fused_cornea_and_lens'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/fused_cornea_and_lens.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_fused_cornea_and_lens.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_fused_cornea_and_lens.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
