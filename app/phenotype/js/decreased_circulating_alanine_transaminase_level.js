...
const target_phenotype = 'decreased_circulating_alanine_transaminase_level'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/decreased_circulating_alanine_transaminase_level.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_decreased_circulating_alanine_transaminase_level.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_decreased_circulating_alanine_transaminase_level.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
