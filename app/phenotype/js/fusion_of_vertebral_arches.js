...
const target_phenotype = 'fusion_of_vertebral_arches'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/fusion_of_vertebral_arches.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_fusion_of_vertebral_arches.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_fusion_of_vertebral_arches.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
