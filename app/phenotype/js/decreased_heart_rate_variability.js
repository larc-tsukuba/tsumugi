...
const target_phenotype = 'decreased_heart_rate_variability'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/decreased_heart_rate_variability.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_decreased_heart_rate_variability.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_decreased_heart_rate_variability.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
