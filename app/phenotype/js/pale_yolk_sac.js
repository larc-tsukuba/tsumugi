...
const target_phenotype = 'pale_yolk_sac'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/pale_yolk_sac.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_pale_yolk_sac.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_pale_yolk_sac.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
