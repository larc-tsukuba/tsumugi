...
const target_phenotype = 'shortened_RR_interval'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/shortened_RR_interval.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_shortened_RR_interval.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_shortened_RR_interval.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
