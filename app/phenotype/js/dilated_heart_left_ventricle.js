...
const target_phenotype = 'dilated_heart_left_ventricle'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/dilated_heart_left_ventricle.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_dilated_heart_left_ventricle.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_dilated_heart_left_ventricle.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
