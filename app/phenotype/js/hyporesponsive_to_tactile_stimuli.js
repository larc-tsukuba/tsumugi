...
const target_phenotype = 'hyporesponsive_to_tactile_stimuli'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/hyporesponsive_to_tactile_stimuli.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_hyporesponsive_to_tactile_stimuli.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_hyporesponsive_to_tactile_stimuli.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
