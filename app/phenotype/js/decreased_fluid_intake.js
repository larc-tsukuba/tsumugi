...
const target_phenotype = 'decreased_fluid_intake'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/decreased_fluid_intake.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_decreased_fluid_intake.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_decreased_fluid_intake.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
