...
const target_phenotype = 'polysyndactyly'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/polysyndactyly.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_polysyndactyly.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_polysyndactyly.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
