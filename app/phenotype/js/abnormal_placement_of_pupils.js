...
const target_phenotype = 'abnormal_placement_of_pupils'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_placement_of_pupils.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_placement_of_pupils.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_placement_of_pupils.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
