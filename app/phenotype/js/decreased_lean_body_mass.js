...
const target_phenotype = 'decreased_lean_body_mass'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/decreased_lean_body_mass.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_decreased_lean_body_mass.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_decreased_lean_body_mass.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
