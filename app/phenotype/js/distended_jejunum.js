...
const target_phenotype = 'distended_jejunum'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/distended_jejunum.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_distended_jejunum.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_distended_jejunum.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
