...
const target_phenotype = 'no_spontaneous_movement'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/no_spontaneous_movement.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_no_spontaneous_movement.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_no_spontaneous_movement.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
