...
const target_phenotype = 'abnormal_heart_position_or_orientation'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_heart_position_or_orientation.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_heart_position_or_orientation.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_heart_position_or_orientation.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
