...
const target_phenotype = 'increased_thermal_nociceptive_threshold'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/increased_thermal_nociceptive_threshold.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_increased_thermal_nociceptive_threshold.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_increased_thermal_nociceptive_threshold.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
