...
const target_phenotype = 'abnormal_thoracic_cage_shape'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_thoracic_cage_shape.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_thoracic_cage_shape.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_thoracic_cage_shape.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
