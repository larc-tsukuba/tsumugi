...
const target_phenotype = 'abnormal_left-right_axis_patterning'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_left-right_axis_patterning.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_left-right_axis_patterning.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_left-right_axis_patterning.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
