...
const target_phenotype = 'decreased_bone_mineral_density'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/decreased_bone_mineral_density.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_decreased_bone_mineral_density.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_decreased_bone_mineral_density.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
