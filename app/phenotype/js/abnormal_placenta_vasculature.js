...
const target_phenotype = 'abnormal_placenta_vasculature'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/abnormal_placenta_vasculature.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_abnormal_placenta_vasculature.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_abnormal_placenta_vasculature.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
