...
const target_phenotype = 'hyperalgesia'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/hyperalgesia.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_hyperalgesia.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_hyperalgesia.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
