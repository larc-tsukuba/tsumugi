...
const target_phenotype = 'increased_mean_corpuscular_hemoglobin_concentration'.replace(/_/g, " ");
...
const elements = (function () {
    ...
    try {
        req.open("GET", "../../data/phenotype/increased_mean_corpuscular_hemoglobin_concentration.json.gz", false);
...
document.getElementById('export-png').addEventListener('click', function () {
    ...
    a.href = pngContent;
    a.download = 'TSUMUGI_increased_mean_corpuscular_hemoglobin_concentration.png';
...
function exportConnectedComponentsToCSV() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = 'TSUMUGI_increased_mean_corpuscular_hemoglobin_concentration.csv';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
}
