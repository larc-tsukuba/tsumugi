...
const url_elements = "../../data/phenotype/embryonic_lethality_prior_to_tooth_bud_stage.json.gz";
...
target_phenotype = "embryonic_lethality_prior_to_tooth_bud_stage".replace(/_/g, " ");
