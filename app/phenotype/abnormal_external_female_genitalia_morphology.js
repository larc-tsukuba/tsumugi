...
const url_elements = "../../data/phenotype/abnormal_external_female_genitalia_morphology.json.gz";
...
target_phenotype = "abnormal_external_female_genitalia_morphology".replace(/_/g, " ");
